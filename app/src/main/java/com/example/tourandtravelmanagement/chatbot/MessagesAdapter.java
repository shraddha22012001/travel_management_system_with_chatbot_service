...
public class MessagesAdapter extends ArrayAdapter<com.example.tourandtravelmanagement.chatbot.Message> {
    ...
    public MessagesAdapter(Context context, com.example.tourandtravelmanagement.chatbot.Messenger messenger) {
        super(context, R.layout.item_message_list, messenger.getGlobalMessages());

        initParams();
    }

    public MessagesAdapter(Context context, List<com.example.tourandtravelmanagement.chatbot.Message> messages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.tourandtravelmanagement.chatbot.Message message = getItem(position);
